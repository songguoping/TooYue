 ...
 */(
    ...
    private var eachItemHPaddingPx //每个条目应该在水平方向上加的padding 总大小，即=paddingLeft+paddingRight
            = 0
    private var sectionEdgeVPaddingPx = 0
    private val mSectionList: MutableList<Section?> =
        ArrayList()
    private var mAdapter: BaseSectionQuickAdapter<SectionEntity, BaseViewHolder>? = null
